...
public class HtmlCssHelper {
	...
	public static String addStyle(String width, String height, String border, String padding, String margin, String backgroundcolor) {
		return STYLE_OPEN + getWidthStyle(width) + getHeightStyle(height) + getBorderStyle(border) + getPaddingStyle(padding) + getMarginStyle(margin) + getBackgroundcolorStyle(backgroundcolor) + CLOSE;
	}
