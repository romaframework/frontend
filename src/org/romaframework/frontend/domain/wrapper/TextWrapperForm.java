...
public class TextWrapperForm extends TextWrapper implements Bindable, ViewCallback {
  ...
  public static final Class[]  JAVA_BASE_CLASSES     = new Class[] { Boolean.class, Byte.class, Character.class, Double.class,
      Float.class, Integer.class, Long.class, Short.class, String.class };

  public static final String[] TYPE_NAMES            = new String[] { Boolean.class.getName(), Byte.class.getName(),
      Character.class.getName(), Double.class.getName(), Float.class.getName(), Integer.class.getName(), Long.class.getName(),
      Short.class.getName(), String.class.getName(), USER_DEFINED_TYPENAME, NOT_HANDLED_TYPENAME };
  ...
  public void onShow() {
    ...
    if (value == null)
      ...
      if (selectedType == null) {
        ...
        selectedType = Roma.schema().isAvailableSchemaClass(Utility.getClassName(cls)) ? USER_DEFINED_TYPENAME
            : NOT_HANDLED_TYPENAME;
      }
    }
