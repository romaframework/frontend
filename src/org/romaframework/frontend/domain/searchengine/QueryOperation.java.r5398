...
public class QueryOperation implements ViewCallback {
	...
	public void showFilters() {
		Roma.setFieldFeature(this, ViewAspect.ASPECT_NAME, "filters", ViewFieldFeatures.VISIBLE, true);
		ObjectContext.getInstance().setActionFeature(this, ViewAspect.ASPECT_NAME, "add", ViewFieldFeatures.VISIBLE, true);
	}

	@ViewAction(visible = AnnotationConstants.FALSE)
	public void hideFilters() {
		Roma.setFieldFeature(this, ViewAspect.ASPECT_NAME, "filters", ViewFieldFeatures.VISIBLE, false);
		ObjectContext.getInstance().setActionFeature(this, ViewAspect.ASPECT_NAME, "add", ViewFieldFeatures.VISIBLE, false);
	}
